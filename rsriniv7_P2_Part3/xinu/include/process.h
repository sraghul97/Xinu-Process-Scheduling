...
struct procent {		/* Entry in the process table		*/
	...
	uint32 process_creation_time;	//Process Creation Time
	...
	uint32 time_allotment; //timeallotment per queue -> MLFQ
	bool8 user_process; //USER PROCESS flag
	uint32 upgrades;	//Priority upgrade counter
	uint32 downgrades;	//Priority udowngrade counter
};
